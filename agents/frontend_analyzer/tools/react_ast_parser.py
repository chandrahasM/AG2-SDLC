"""
React/TypeScript AST Parser for Frontend Analysis
Analyzes React components, hooks, props, and TypeScript interfaces
"""
...
class ReactASTParser:
    """Parses React/TypeScript files for component analysis"""
    ...
    def __init__(self):
        ...
        self.component_patterns = {
            ...
            'export_named': r'export\s+(?:const|function|class)\s+(\w+)',
